...
function MaterialCardItem({item, studyTypeContent }) {
  return (
    ...
    `}>
      ...
      <h2 className='p-1 px-1 py-1 bg-gray-500 text-white rounded-full text-[10px] mb-2'>Not Ready</h2>
      : <h2 className='p-1 px-1 py-1 bg-green-500 text-white rounded-full text-[10px] mb-2'>Ready</h2>}
